...
#line 283 "src/prebuilt/wast-lexer-gen.cc"
{
	unsigned char yych;
...
#line 323 "src/wast-lexer.cc"
	{ SetText(); RETURN(TEXT); }
#line 350 "src/prebuilt/wast-lexer-gen.cc"
yy11:
	yyaccept = 0;
...
#line 320 "src/wast-lexer.cc"
	{ ERROR("bad escape \"%.*s\"",
                                  ...
                                  continue; }
#line 447 "src/prebuilt/wast-lexer-gen.cc"
yy22:
	yych = *++cursor_;
	if (yych <= '@') {
		if (yych <= '/') goto yy21;
...
#line 555 "src/wast-lexer.cc"
	{ continue; }
#line 535 "src/prebuilt/wast-lexer-gen.cc"
yy36:
	++cursor_;
...
#line 554 "src/prebuilt/wast-lexer-gen.cc"
yy42:
	yych = *++cursor_;
...
#line 551 "src/wast-lexer.cc"
	{ if (--COMMENT_NESTING == 0)
                                    BEGIN(YYCOND_i);
                                  continue; }
#line 596 "src/prebuilt/wast-lexer-gen.cc"
yy52:
	yych = *++cursor_;
...
#line 548 "src/wast-lexer.cc"
		{ continue; }
#line 687 "src/prebuilt/wast-lexer-gen.cc"
yy60:
		++cursor_;
		BEGIN(YYCOND_i);
